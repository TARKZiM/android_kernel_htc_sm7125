...
#define AFE_PARAM_ID_AWDSP_RX_SET_L_VMAX (0x10013D17)
#define AFE_PARAM_ID_AWDSP_RX_SET_R_VMAX (0x10013D18)
				...
				union afe_spkr_prot_config *prot_config)
{
	...
	case AFE_PARAM_ID_AWDSP_RX_SET_L_VMAX:
	case AFE_PARAM_ID_AWDSP_RX_SET_R_VMAX:
	case AFE_PARAM_ID_AWDSP_RX_CALI_CFG_L:
	case AFE_PARAM_ID_AWDSP_RX_CALI_CFG_R:
	case AFE_PARAM_ID_AWDSP_RX_RE_L:
	case AFE_PARAM_ID_AWDSP_RX_RE_R:
	case AFE_PARAM_ID_AWDSP_RX_NOISE_L:
	case AFE_PARAM_ID_AWDSP_RX_NOISE_R:
	case AFE_PARAM_ID_AWDSP_RX_F0_L:
	case AFE_PARAM_ID_AWDSP_RX_F0_R:
	case AFE_PARAM_ID_AWDSP_RX_REAL_DATA_L:
	case AFE_PARAM_ID_AWDSP_RX_REAL_DATA_R:
